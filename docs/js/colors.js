...
import { jigsawGenerator } from '/js/jigsawShield.js?v=2.0.2'
import { shuffleArray, normalizeVraiment, logFunc, generateElement } from "/js/utils.js?v=2.0.2"
import MagnificentTitle from "/js/magnificent-title.js?v=2.0.2"
