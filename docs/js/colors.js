...
import { jigsawGenerator } from '/js/jigsawShield.js?v=2.0.4'
import { shuffleArray, normalizeVraiment, logFunc, generateElement } from "/js/utils.js?v=2.0.4"
import MagnificentTitle from "/js/magnificent-title.js?v=2.0.4"
