import { generateElement } from "/js/utils.js?v=1.0.2-alpha.2"

class MagnificentTitle {
    templateForTheme
    
    constructor(clazz, whereParam, incl) {
        const where = whereParam && (whereParam === 1 || whereParam === 2) ? whereParam : 0 // 1, 2, 3
        // where can be left middle right
        const arrow_out_left = `<svg id="arrow_out_left" class="magnificient-arrow left" viewBox="0 0 20 20">
            <path d="m4.671 5.06 1.454 1.348L3.697 9h8.366v2H3.697l2.428 2.544-1.454 1.362L0 9.958ZM10 0v4h2V2h6v16h-6v-2h-2v4h10V0Z"/>
        </svg>`
        const arrow_in_left = `<svg id="arrow_in_left" class="magnificient-arrow left" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M7.757 10.233 13 5.99V9h7v2h-7v3.476l-5.243-4.243ZM10 4H8V2H2v16h6v-2h2v4H0V0h10v4Z"/>
        </svg>`
        const arrow_in_right = `<svg id="arrow_in_right" class="magnificient-arrow right" viewBox="0 0 20 20">
        ...
        const arrow_out_right = `<svg id="arrow_out_right" class="magnificient-arrow right" viewBox="0 0 20 20">
