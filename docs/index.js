...
import codec from "/js/structure.js?v=2.0.1"
import { colorArray } from "/js/colors.js?v=2.0.1"
import { theArtists } from "/js/artists.js?v=2.0.1"
import { shuffleArray, generateElement } from "/js/utils.js?v=2.0.1"
import { jigsawGenerator } from '/js/jigsawShield.js?v=2.0.1'
import MagnificentTitle from "/js/magnificent-title.js?v=2.0.1"
