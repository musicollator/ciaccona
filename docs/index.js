...
import { colorArray } from "/js/colors.js?v=1.0.1-alpha
import { shuffleArray, generateElement } from "/js/utils.js?v=1.0.1-alpha
...
loadArtists().then(putainDeArtists => {
    ...
    &nbsp;
    <img class="align-self-center" src="index.svg?v=1.0.1-alphaclose-circle-view" style="width:32px; height:32px;">
</div>
`
