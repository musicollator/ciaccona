...
import { jigsawGenerator } from "/js/jigsawShield.js?v=1.0.2-alpha.1"
...
loadArtists().then(putainDeArtists => {
    ...
    &nbsp;
    <img class="align-self-center" src="index.svg?v=1.0.2-alpha.1#close-circle-view" style="width:32px; height:32px;">
</div>
`
