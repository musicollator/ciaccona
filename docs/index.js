...
import codec from "/js/structure.js?v=1.0.0-alpha"
import { loadArtists } from "/js/artists.js?v=1.0.0-alpha"
import { colorArray } from "/js/colors.js?v=1.0.0-alpha"
import { shuffleArray, generateElement } from "/js/utils.js?v=1.0.0-alpha"
import { jigsawGenerator } from "/js/jigsawShield.js?v=1.0.0-alpha"
import MagnificentTitle from "/js/magnificent-title.js?v=1.0.0-alpha"
...
loadArtists().then(putainDeArtists => {
    ...
    &nbsp;
    <img class="align-self-center" src="index.svg?v=1.0.0-alpha#close-circle-view" style="width:32px; height:32px;">
</div>
`
