...
import { colorArray } from "/js/colors.js?v=2.2.13"
import { theArtists } from "/js/artists.js?v=2.2.13"
import { shuffleArray, generateElement } from "/js/utils.js?v=2.2.13"
import { jigsawGenerator } from "/js/jigsawShield.js?v=2.2.13"
import MagnificentTitle from "/js/magnificent-title.js?v=2.2.13"
