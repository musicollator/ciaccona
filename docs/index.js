...
import { loadArtists } from "/js/artists.js?v=1.0.1-alpha.1"
import { colorArray } from "/js/colors.js?v=1.0.1-alpha.1"
import { shuffleArray, generateElement } from "/js/utils.js?v=1.0.1-alpha.1"
...
loadArtists().then(putainDeArtists => {
    ...
    &nbsp;
    <img class="align-self-center" src="index.svg?v=1.0.1-alpha.1#close-circle-view" style="width:32px; height:32px;">
</div>
`
