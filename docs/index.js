...
import codec from "/js/structure.js?v=2.2.17"
import { colorArray } from "/js/colors.js?v=2.2.17"
import { theArtists } from "/js/artists.js?v=2.2.17"
import { shuffleArray, generateElement } from "/js/utils.js?v=2.2.17"
import { jigsawGenerator } from "/js/jigsawShield.js?v=2.2.17"
import MagnificentTitle from "/js/magnificent-title.js?v=2.2.17"
...

{
    ...
    &nbsp;
    <img class="align-self-center" src="index.svg?v=2.2.17#close-circle-view" style="width:32px; height:32px;">
</div>
`
