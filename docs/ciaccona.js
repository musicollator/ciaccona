...
import { togglePlayer } from "/js/playerSingleton.js?v=2.2.24"
import { createColoredBadges } from "/js/colors.js?v=2.2.24"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=2.2.24"
import { loadArtists } from "/js/artists.js?v=2.2.24"
import Ω from "/js/dom.js?v=2.2.24"
