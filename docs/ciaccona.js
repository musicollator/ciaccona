...
import config from "/js/config.js?v=1.0.0-alpha"
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.0-alpha"
import { createColoredBadges } from "/js/colors.js?v=1.0.0-alpha"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.0-alpha"
import { loadArtists } from "/js/artists.js?v=1.0.0-alpha"
import Ω from "/js/dom.js?v=1.0.0-alpha"
