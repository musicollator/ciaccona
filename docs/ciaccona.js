...
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.2-alpha"
import { createColoredBadges } from "/js/colors.js?v=1.0.2-alpha"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.2-alpha"
