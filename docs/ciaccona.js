...
import { togglePlayer } from "/js/playerSingleton.js?v=2.1.0"
import { createColoredBadges } from "/js/colors.js?v=2.1.0"
import { createPlayerSingleton, showPlayer} from "/js/playerSingleton.js?v=2.1.0"
import Ω from "/js/dom.js?v=2.1.0"
