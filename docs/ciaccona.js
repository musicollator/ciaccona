...
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.4-beta"
import { createColoredBadges } from "/js/colors.js?v=1.0.4-beta"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.4-beta"
import { loadArtists } from "/js/artists.js?v=1.0.4-beta"
import Ω from "/js/dom.js?v=1.0.4-beta"
