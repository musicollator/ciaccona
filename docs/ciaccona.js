...
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.1-alpha.1"
import { createColoredBadges } from "/js/colors.js?v=1.0.1-alpha.1"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.1-alpha.1"
