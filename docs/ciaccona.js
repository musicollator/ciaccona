...
import config from "/js/config.js?v=2.2.1"
import codec from "/js/structure.js?v=2.2.1"
import { togglePlayer } from "/js/playerSingleton.js?v=2.2.1"
import { createColoredBadges } from "/js/colors.js?v=2.2.1"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=2.2.1"
import Ω from "/js/dom.js?v=2.2.1"
