...
import { togglePlayer } from "/js/playerSingleton.js?v=2.1.2"
import { createColoredBadges } from "/js/colors.js?v=2.1.2"
import { createPlayerSingleton, showPlayer} from "/js/playerSingleton.js?v=2.1.2"
