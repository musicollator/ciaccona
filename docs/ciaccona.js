...
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.1-alpha
import { createColoredBadges } from "/js/colors.js?v=1.0.1-alpha
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.1-alpha
import { loadArtists } from "/js/artists.js?v=1.0.1-alpha
import Ω from "/js/dom.js?v=1.0.1-alpha
