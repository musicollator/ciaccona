...
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.0-alpha.1"
import { createColoredBadges } from "/js/colors.js?v=1.0.0-alpha.1"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.0-alpha.1"
import { loadArtists } from "/js/artists.js?v=1.0.0-alpha.1"
import Ω from "/js/dom.js?v=1.0.0-alpha.1"
