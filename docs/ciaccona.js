...
import config from "/js/config.js?v=1.0.2-alpha.2"
import { togglePlayer } from "/js/playerSingleton.js?v=1.0.2-alpha.2"
import { createColoredBadges } from "/js/colors.js?v=1.0.2-alpha.2"
import { createPlayerSingleton, showPlayer } from "/js/playerSingleton.js?v=1.0.2-alpha.2"
import { loadArtists } from "/js/artists.js?v=1.0.2-alpha.2"
import Ω from "/js/dom.js?v=1.0.2-alpha.2"
