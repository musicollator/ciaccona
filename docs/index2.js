...
import { jigsawGenerator } from "/js/jigsawShield.js?v=1.0.4-beta"
...
&nbsp;
<img class="align-self-center" src="index.svg?v=1.0.4-beta#close-circle-view" style="width:32px; height:32px;">
</div>
`
