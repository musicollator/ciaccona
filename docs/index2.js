...
import { colorArray } from "/js/colors.js?v=1.0.3-beta.1"
import { shuffleArray, generateElement } from "/js/utils.js?v=1.0.3-beta.1"
import { jigsawGenerator } from "/js/jigsawShield.js?v=1.0.3-beta.1"
import MagnificentTitle from "/js/magnificent-title.js?v=1.0.3-beta.1"
...
&nbsp;
<img class="align-self-center" src="index.svg?v=1.0.3-beta.1#close-circle-view" style="width:32px; height:32px;">
</div>
`
