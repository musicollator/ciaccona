...
import config from "/js/config.js?v=1.0.2-alpha.3"
import codec from "/js/structure.js?v=1.0.2-alpha.3"
import { loadArtists } from "/js/artists.js?v=1.0.2-alpha.3"
import { colorArray } from "/js/colors.js?v=1.0.2-alpha.3"
import { shuffleArray, generateElement } from "/js/utils.js?v=1.0.2-alpha.3"
import { jigsawGenerator } from "/js/jigsawShield.js?v=1.0.2-alpha.3"
import MagnificentTitle from "/js/magnificent-title.js?v=1.0.2-alpha.3"
...
&nbsp;
<img class="align-self-center" src="index.svg?v=1.0.2-alpha.3#close-circle-view" style="width:32px; height:32px;">
</div>
`
